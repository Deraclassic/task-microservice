package com.dera.taskboard.web.rest;

import static com.dera.taskboard.domain.TaskAsserts.*;
import static com.dera.taskboard.web.rest.TestUtil.createUpdateProxyForBean;
import static org.assertj.core.api.Assertions.assertThat;
import static org.hamcrest.Matchers.hasItem;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.*;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import com.dera.taskboard.IntegrationTest;
import com.dera.taskboard.domain.Task;
import com.dera.taskboard.repository.TaskRepository;
import com.dera.taskboard.service.dto.TaskDTO;
import com.dera.taskboard.service.mapper.TaskMapper;
...
class TaskResourceIT {
    ...
    private static final String DEFAULT_PRIORY_LEVEL = "AAAAAAAAAA";
    private static final String UPDATED_PRIORY_LEVEL = "BBBBBBBBBB";
    ...
    public static Task createEntity(EntityManager em) {
        Task task = new Task().title(DEFAULT_TITLE).description(DEFAULT_DESCRIPTION).prioryLevel(DEFAULT_PRIORY_LEVEL);
        return task;
    }
    ...
    public static Task createUpdatedEntity(EntityManager em) {
        Task task = new Task().title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).prioryLevel(UPDATED_PRIORY_LEVEL);
        return task;
    }
    ...
    void getAllTasks() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.[*].prioryLevel").value(hasItem(DEFAULT_PRIORY_LEVEL)));
    }
    ...
    void getTask() throws Exception {
        ...
        restTaskMockMvc
            ...
            .andExpect(jsonPath("$.prioryLevel").value(DEFAULT_PRIORY_LEVEL));
    }
    ...
    void putExistingTask() throws Exception {
        ...
        updatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).prioryLevel(UPDATED_PRIORY_LEVEL);
    ...
    void partialUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.description(UPDATED_DESCRIPTION).prioryLevel(UPDATED_PRIORY_LEVEL);
    ...
    void fullUpdateTaskWithPatch() throws Exception {
        ...
        partialUpdatedTask.title(UPDATED_TITLE).description(UPDATED_DESCRIPTION).prioryLevel(UPDATED_PRIORY_LEVEL);
